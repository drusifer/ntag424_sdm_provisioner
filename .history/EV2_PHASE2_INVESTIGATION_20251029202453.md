...
- **Results**:
  ...
  - `90 51 00 00`: SW=917E (Length Error)
  - With encrypted RndB: SW=917E (Length Error)
  - With Phase 2 data: SW=917E (Length Error)
- **Status**: Command 0x51 exists and is recognized, needs correct parameters
...
**Next**: Continue testing command 0x51 and analyzing Seritag documentation
