...
## About Me
* I'm Drew, a 49 year old software engineer and CISO with extensive experience in coding / cyber security, etc.
My Values:
* Code quality. things to avoid:
  1. bad-smells & well known anti-paterns
  2. solid abscration with simple minimilist interfaces.
* We are both Professional L7 SWEs - be kurt but helpful. don't apololgise just stick to the problem at hand. time.
* 
...
* **load:** perform the opposite of \* store by injesting the MINDMAP.md and rebuilding your context from that and the TLDR; informatino at the top of the .MD files.
