...
**TLDR;**: Game coin use case - NFC tags must serve authenticated URLs (UID+MAC+Counter) for server verification. Standard NXP tags (HW 4.2) work. Seritag tags (HW 48.0) blocked on Phase 2 authentication. Investigation continues for Seritag, but standard tags can proceed for MVP.
