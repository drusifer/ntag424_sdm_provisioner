...
def provision_with_error_handling():
    ...
    try:
        with CardManager(0) as card:
            ...
            if not factory_auth_works:
                print("\n⚠️  WARNING: Tag appears to be already configured!")
                print("⚠️  Factory key authentication failed - keys may have been changed.")
                print("⚠️  Continuing with provisioning may fail or overwrite existing configuration.")
