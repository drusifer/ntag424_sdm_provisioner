...
def test_seritag_authentication():
    ...
    try:
        ...
        if ev2_success:
            ...
            print(f"\n❌ EV2 Authentication failed with simulator")
            print(f"   This indicates a bug in our simulator implementation")
            print(f"   Need to fix the simulator before testing with real tags")
