...
class SeritagSimulator:
    ...
    def _handle_get_version(self) -> Tuple[List[int], int, int]:
        ...
        # Return 29 bytes according to NTAG424 DNA specification:
        ...
        version_data.extend(self.state.batch_no[:4])
        
        # Add fabrication info (3 bytes)
        version_data.extend([
            0x00,  # fab_key
    ...
    def _handle_authenticate_ev2_second(self, p1: int, p2: int, data: List[int]) -> Tuple[List[int], int, int]:
        ...
        # Encrypt response
        cipher_encrypt = AES.new(key, AES.MODE_ECB)  # No padding during authentication per spec
