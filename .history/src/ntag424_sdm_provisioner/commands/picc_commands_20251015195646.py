...
from ntag424_sdm_provisioner.hal import CardConnection, ApduError, SW_OK
...
class GetFirmwareVersion(ApduCommand):
    ...
    def execute(self, connection: CardConnection) -> str:
        """
...
class LedAndBuzzerControl(ApduCommand):
    ...
    def execute(self, connection: CardConnection) -> LedStatus:
        """
