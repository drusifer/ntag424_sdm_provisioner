...
from ntag424_sdm_provisioner.commands.base import AdpuCommand
from ntag424_sdm_provisioner.hal import CardManager, CardConnection
...
class ChipCheck(AdpuCommand):
    """Sends a generic ISO 7816-4 command to check chip compatibility."""
    def execute(self, connection: CardConnection) -> bytes:
