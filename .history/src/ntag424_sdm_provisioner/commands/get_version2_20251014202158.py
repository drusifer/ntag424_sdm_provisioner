...
from ntag424_sdm_provisioner.commands.base import ApduCommand, ApduError, CLA_PROPRIETARY, INS_GET_VERSION, INS_GET_MORE, SW_OK, SW_MORE_DATA   
...
class GetVersion(ApduCommand):
    ...
    def execute(self, connection: NTag424CardConnection) -> VersionInfo:
        """
        Executes the command sequence to get the NTAG424 version.

        Args:
            connection: An active card connection.
        ...
        _, sw1, sw2 = self.send_apdu(connection, self.SELECT_APDU)
