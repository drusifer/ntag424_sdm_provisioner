...
class AuthenticateEV2Part2(ApduCommand):
    ...
    def __init__(self, key: bytes, rndB: bytes):
        """
        Args:
            key: The 16-byte AES-128 key used for authentication.
    ...
    # Use a fresh cipher instance for encryption (CBC with zero IV)
    ...
    # Use a fresh cipher instance for decryption to avoid stateful errors
