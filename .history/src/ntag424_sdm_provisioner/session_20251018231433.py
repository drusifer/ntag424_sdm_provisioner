...
from ntag424_sdm_provisioner.hal import CardConnection
from ntag424_sdm_provisioner.commands.sdm_commands import AuthenticateEV2First, AuthenticateEV2Second
